...
import { PNotificationHandler } from "../p-notification-handler"
import { PNotificationPreview } from "./p-notification-preview"

<Meta 
    subcomponents={[PNotificationHandler]}
    components={PNotificationPreview}
